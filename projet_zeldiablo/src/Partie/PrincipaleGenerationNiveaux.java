...
//        Niveau n = UsineNiveau.getNiveau("niveaux/niveau2.obj");
////
//
//
//        UsineNiveau.saveNiveau("niveaux/niveau2.obj", n);

//        for(int i = 0; i < 4; i++) {
//
//            HashMap<TYPE_MONSTRE, Integer> montres_lvl_2 = new HashMap<>();
//            montres_lvl_2.put(TYPE_MONSTRE.MONSTRE_IMMO, 3);
//            montres_lvl_2.put(TYPE_MONSTRE.MONSTRE_TROLL, 1);
//            Niveau n2 = UsineNiveau.getNiveau(montres_lvl_2);
//            UsineNiveau.saveNiveau("niveaux/nivea2_" +i+ ".obj", n2);
//        }
